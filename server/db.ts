  ...
  try {
    ...
    if (parseInt(msgCount.rows[0].count) === 0) {
      await client.query(`
        ...
        ('ftue_rewards', 'ftue', 'Earn Good Coins', 'Complete missions, spin the wheel, and earn Good Coins. Redeem them for gift cards and rewards!', 'Awesome', null, 'rewards', 'gift-outline', '#D4AF37', 'first_time_only', 4, 4),
